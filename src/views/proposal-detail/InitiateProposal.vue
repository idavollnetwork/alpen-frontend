            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="form-page-1">
                  ...
                  <div class="input-wrap" v-for="(option, index) in choices"
                       :key="index">
                    <div class="name">
                      {{ $t('proposal.create.choice') + ' ' + ( index + 1) }}
                    </div>
                    <div class="input-wrap-choice">
                      <input
                        type="text"
                        v-model="choices[index]"
                        class="data-input"
                        :placeholder="$t('pleaseEnterOptionInformation')">
                      <img
                ...
                <div class="middle-cont input-content">
                  ...
                  <div class="input-wrap">
                    <div class="title-name">
                      <span>{{ $t('v11.votecountingRule') }}</span>
                    </div>
                    <div class="select-buttons">
                      <b-button
                        class="select-button"
                        pill
                        :variant="ruleSelected === 0 ? 'outline-primary' : 'outline-secondary'"
                        @click="tapRuleButton(0)"
                      >
                        {{ $t('v11.addressCount') }}
                      </b-button>
                      <b-button
                        pill
                        class="select-button"
                        :variant="ruleSelected === 1 ? 'outline-primary' : 'outline-secondary'"
                        @click="tapRuleButton(1)"
                      >
                        {{ $t('v11.voteCount') }}
                      </b-button>
                    </div>
...
export default {
  ...
  data() {
    return {
      ...
      optionsArr: [
        {
          name: this.$t('proposal.create.singleS'),
          type: 1,
        },
        {
          name: this.$t('proposal.create.multipleS'),
          type: 2,
        },
      ],
      selectedOption: {
